...
This skill runs under this repo's `.github/copilot-instructions.md`. Findings are reported for human review only — no workflow file is auto-edited, no commit/push happens as part of a review, and no PR is opened unless explicitly asked. English only in all output.
